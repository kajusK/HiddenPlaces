...
def add():
    ...
    if form.validate_on_submit():
        ...
        EventLog.log(current_user, event.CreateCategoryEvent(category))
        db.session.commit()
...
def delete(category_id: int):
    ...
    category.delete()
    EventLog.log(current_user, event.DeleteCategoryEvent(category))
    db.session.commit()
...
def edit(category_id: int):
    ...
    if request.method == 'GET':
        ...
        EventLog.log(current_user, event.ModifyCategoryEvent(category))
        db.session.commit()
