...
class Underground(DBItem):
    ...
    type = db.Column(IntEnum(constants.UndergroundType), nullable=False)
    state = db.Column(IntEnum(constants.UndergroundState), nullable=False)
    accessibility = db.Column(IntEnum(constants.UndergroundAccessibility))
...
class Material(DBItem):
    ...
    type = db.Column(IntEnum(constants.MaterialType), nullable=False)
